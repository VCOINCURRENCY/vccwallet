...
const ToAddrBox = ({
  ...
  const usdValue = Utils.getVccToUsdString(vccPrice, toaddr.amount);
...
const ConfirmModalToAddr = ({ toaddr, info }) => {
  const { bigPart, smallPart } = Utils.splitVccAmountIntoBigSmall(toaddr.amount);
        ...
        <div className={[cstyles.verticalflex, cstyles.right].join(' ')}>
          <div className={cstyles.large}>
            <div>
              ...
              <span className={[cstyles.small, styles.vccsmallpart].join(' ')}>{smallPart}</span>
            </div>
          </div>
          <div>{Utils.getVccToUsdString(info.vccPrice, toaddr.amount)}</div>
        </div>
      </div>
...
const ConfirmModalInternal = ({
  ...
  const { bigPart, smallPart } = Utils.splitVccAmountIntoBigSmall(sendingTotal);
        ...
        <div className={cstyles.flex}>
          ...
          >
            ...
            <div className={[cstyles.right, cstyles.verticalflex].join(' ')}>
              ...
              <div className={cstyles.normal}>{Utils.getVccToUsdString(info.vccPrice, sendingTotal)}</div>
            </div>
          </div>
        </div>
